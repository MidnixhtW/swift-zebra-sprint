...
An Eastern Christian watchfulness and prayer React/Vite app for military, first responders, public safety, medical teams, chaplains, dispatchers, security, and the wider service-and-protection community. It is configured for Android packaging with Capacitor.

## Field Manual

The app includes a dedicated `/field-manual` page with service-focused field cross branding, short field prayers, practical battle-rhythm prompts, and pastoral/safety notes for duty, stress, travel, grief, courage, the wounded/sick, the departed, and thanksgiving after danger.
