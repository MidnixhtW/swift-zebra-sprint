import { Hand, MoonStar, Sun } from "lucide-react";
      ...
      <Card className="rounded-3xl border-border/60 bg-card p-5 shadow-sm">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              A short, reliable rule you can actually keep — with OCA sources.
            </p>
          </div>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="morning" className="border-none">
            <AccordionTrigger className="rounded-2xl border border-border/60 bg-muted/20 px-4 text-left hover:no-underline">
              <span className="inline-flex items-center gap-2">
                <Sun className="h-4 w-4 text-primary" /> Morning (short rule)
              </span>
            </AccordionTrigger>
            <AccordionContent className="pt-3">
              <div className="grid gap-3">
                ...
                <PrayerBlock
                  title="Jesus Prayer (optional: 10–100)"
                  lines={jesus}
                />
          ...
          <AccordionItem value="evening" className="mt-3 border-none">
            <AccordionTrigger className="rounded-2xl border border-border/60 bg-muted/20 px-4 text-left hover:no-underline">
              <span className="inline-flex items-center gap-2">
                <MoonStar className="h-4 w-4 text-primary" /> Evening (short rule)
              </span>
            </AccordionTrigger>
            <AccordionContent className="pt-3">
              <div className="grid gap-3">
            ...
            <AccordionContent className="pt-3">
              <div className="space-y-2 text-sm leading-relaxed text-muted-foreground">
                <p>
                  ...
                  text and wider prayer collections, open the OCA sources above.
                </p>
                <p>
