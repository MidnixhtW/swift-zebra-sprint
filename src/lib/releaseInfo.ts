...
export const RELEASE_NOTES: ReleaseNote[] = [
  {
    ...
    changes: [
      "Added the Eastern Christian Field Manual for duty, stress, travel, grief, courage, the wounded/sick, the departed, and thanksgiving after danger.",
      "Added dedicated Android APK download page with install instructions, safety notes, version display, and release metadata.",
      "Added field cross branding, favicon, and app manifest metadata.",
